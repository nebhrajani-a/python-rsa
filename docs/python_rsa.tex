...
% \pretitle{
%   \begin{center}
% \includegraphics[scale = 0.45]{tos_logo.jpeg}\\
% {\Large \bfseries The Orchid School, Pune}\\[0.5in]
% {\Large A Project Report On}\\
%     \Huge\bfseries }
% \renewcommand\maketitlehookb{
%   \begin{center}
% For AISSCE 2021 Examination\\
% As a part of the Informatics Practices Course (065)\\[0.5in]
%       \bfseries {\large Submitted by}
%   \end{center}
% }
% \predate{}
% \postdate{}
...
%   \begin{center}
%     \large{ Under the Guidance of\\ Ms. Jayashri Samudra\\[0.3cm] \textbf{2020-2021}\\ }
%   \end{center}
% }
%-------------------------------------------------------------------------------------------------%
...
% {\center\huge\textbf {Certificate}\\[0.5in]}

% This is to certify that the project entitled \textbf{RSA Encryption
%   Tool} is a bonafide work done by Mr. Aditya V. Nebhrajani of class XII session 2020-21 in partial fulfilment of CBSE's Examination 2021 for the subject Informatics Practices (065) and has been carried out under my guidance. \\

% This report or a similar report on the topic has not been submitted for any other examination and does not form a part of any other course undergone by the candidate.\\[1.5cm]

% \begin{center}
% \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}X  >{\centering\arraybackslash}X}
% Student & Teacher In-Charge \\ (Mr. Aditya V. Nebhrajani)& (Ms.
% Jayashri Samudra)\\[1.5cm] Unit Head & Acting Principal \\ (Ms. Netre
% Kulkarni) & (Ms. Sangeeta Kapoor) \\
% \end{tabularx}
% \end{center}
% \vspace*{1.5cm}
% \begin{center}
...
% \vspace*{1cm}
% \textbf{Place: } The Orchid School, Pune. \hfill \textbf{Date}:~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
% I undertook this project, as the of my grade XII Informatics
% Practices (065) course. I tried to apply the best of my knowledge and
% experience gained during study and class work.
...
% Moreover, the developer always requires the help and good wishes of
% the people around who have considerable experience and novel ideas.

% I would like to extend my sincere thanks and gratitude to my teacher
% Ms. Jayashri Samudra for guiding us throughout the life cycle of
% Software Development.
% I would like to take the opportunity to extend my sincere thanks and gratitude to my Unit Head Ms. Netre Kulkarni for giving valuable time and moral support to develop this software.
% I am very much thankful to our Acting Principal Ms. Sangeeta Kapoor for being a source of inspiration.
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      xlabel={Test Number}, ylabel={Time}, legend pos=north west]

      \addplot[color=black, mark=*] coordinates {
        (1,10.32)(2,10.3)(3,10.41)(4,10.42)(5,10.395)(6,10.39)(7,10.375)(8,10.52)(9,10.35)(10,10.73)};
      \legend{Time per test}
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[color=black, mark=*] coordinates {
        (1,158.27)(2,158.38)(3,158.32)(4,158.15)(5,158.85)};
      \legend{Time per test}
    \end{axis}
  \end{tikzpicture}
